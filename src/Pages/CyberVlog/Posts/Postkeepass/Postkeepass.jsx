    ...
    <>
      <div className="flex flex-col gap-4 justify-center items-center">
        ...
        <article className="flex flex-col">
          ...
          <img src="\src\Pages\CyberVlog\Posts\Postkeepass\src\step_1.png" alt="Descarga KeePassXC" className="my-4 rounded-lg" />
        </article>
        <article className="flex flex-col">
          ...
          <img src="\src\Pages\CyberVlog\Posts\Postkeepass\src\step_2.png" alt="Instala KeePassXC" className="my-4 rounded-lg self-center" />
        </article>
        <article className="flex flex-col">
          ...
          <img src="\src\Pages\CyberVlog\Posts\Postkeepass\src\step_3.png" alt="Crea una DB" className="my-4 rounded-lg" />
        </article>
        <article className="flex flex-col">
          ...
          <img src="\src\Pages\CyberVlog\Posts\Postkeepass\src\step_4.png" alt="Crea una DB" className="my-4 rounded-lg" />
        </article>
        <article className="flex flex-col">
          ...
          <img src="\src\Pages\CyberVlog\Posts\Postkeepass\src\step_5.png" alt="Crea una DB" className="my-4 rounded-lg" />
        </article>
        <article className="flex flex-col">
          ...
          <img src="\src\Pages\CyberVlog\Posts\Postkeepass\src\step_6.jpg" alt="Descarga KeePassXC" className="my-4 rounded-lg" />
        </article>
