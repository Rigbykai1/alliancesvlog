    ...
    <div className="flex flex-col max-w-4xl self-center mx-4 mb-4">
      <div className="max-w-lg self-center">
        ...
        <p className="m-6 text-center">
          <span className="font-bold text-accent">¡Bienvenido a mi vlog!</span>{" "}
          Acá comparto lo que voy aprendiendo sobre tecnología: apps útiles,
          tutoriales, ciberseguridad, redes y más. Me gusta explicar todo claro
          y sin vueltas, con contenido que sea útil, directo y fácil de
          entender. Si te interesa el mundo tech, seguro encontrás algo que te
          sirva. <span className="animate-bounce">🚀</span>
        </p>
      </div>
      <div className="flex flex-row flex-wrap gap-4 items-center justify-center">
        ...
        ${
          index === (hoveredCard !== null ? hoveredCard : activeCard)
            ? "bg-accent/20 scale-105 animate-pulse"
            : "bg-base-100"
        }
      ...
      `}
            ...
            >
              <div className="p-4 ">
                <h2 className="text-xl text-center text-base-content font-semibold mb-2">
                  {post.title}
                </h2>
              </div>
            </div>
