...
const Home = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center text-center animate-fade animate-duration-500 animate-ease-linear transition-all">
          ...
          <div className="flex flex-col md:flex-row gap-4 py-4">
            <article className="flex flex-col p-8  min-h-56 max-h-80 justify-center max-w-md min-w-80 bg-info/60 hover:bg-info/40 rounded-lg">
              <h1 className="font-bold text-3xl text-info-content">
                {" "}
                <span className="animate-pulse">{">"}</span> Programador jr
              </h1>
      ...
      <Globe
        key={theme}
        mainSphereColor={sphereColors.main}
        interactionSphereColor={sphereColors.interaction}
